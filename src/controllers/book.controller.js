...
const addBook = asyncHandler(async (req, res) => {
    ...
    return res.json(new ApiResponse("Book added successfully", 201, book));
});
...
const getAllBooks = asyncHandler(async (req, res) => {
    ...
    return res.json(new ApiResponse("Books fetched successfully", 200, books));
});
...
const getBookById = asyncHandler(async (req, res) => {
    ...
    return res.json(new ApiResponse("Book fetched successfully", 200, book));
});
...
const updateBook = asyncHandler(async (req, res) => {
    ...
    if (floorNumber !== undefined) book.floorNumber = floorNumber;
    if (rackNo !== undefined) book.rackNo = rackNo;
    if (isFacultyReserved !== undefined) book.isFacultyReserved = isFacultyReserved;

    await book.save();

    return res.json(new ApiResponse("Book updated successfully", 200, book));
});
...
const changeAvailability = asyncHandler(async (req, res) => {
    ...
    return res.json(new ApiResponse("Book availability updated successfully", 200, book));
});
...
const issueBook = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        return res.json(new ApiResponse("Book issued successfully", 200, bookAllocation[0]));
...
const returnBook = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const bookAllocation = await BookAllocation.findOne({
            book: book._id,
            returnDate: { $eq: null }
        }).session(session);
        ...
        return res.json(new ApiResponse("Book returned successfully", 200, book));
